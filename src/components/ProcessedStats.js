...
function ProcessedStats(props){
  return (
    <React.Fragment>
        <h1 className="font-bold leading-relaxed uppercase text-center">What do we do with our bikes?</h1>
            ...
            <div className="container w-100 lg:w-4/5 mx-auto flex flex-col">
              <div v-for="card in cards" className="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100 mx-2">
                ...
                <div className="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                  ...
                  <h2 className="font-semibold leading-tight truncate bg-emerald-500 text-white  uppercase text-base px-8 py-3 rounded shadow mr-1 mb-1 ease-linear transition-all duration-150 text-center">Bikes granted: { props.grantedBikesCount }
                  </h2>
                </div>
              </div>
            </div>
              ...
              <div className="container w-100 lg:w-4/5 mx-auto flex flex-col">
                <div v-for="card in cards" className="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100 mx-2">
                  ...
                  <div className="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                    ...
                    <h2 className="font-semibold leading-tight truncate bg-emerald-500 text-white  uppercase text-base px-8 py-3 rounded shadow mr-1 mb-1 ease-linear transition-all duration-150 text-center">Bikes sold: { props.soldBikesCount }
                    </h2>
                  </div>
                </div>
              </div>
              ...
              <div className="container w-100 lg:w-4/5 mx-auto flex flex-col">
                <div v-for="card in cards" className="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100 mx-2">
                  ...
                  <div className="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                    ...
                    <h2 className="font-semibold leading-tight truncate bg-emerald-500 text-white  uppercase text-base px-8 py-3 rounded shadow mr-1 mb-1 ease-linear transition-all duration-150 text-center">Bikes scrapped: { props.scrappedBikesCount }</h2>
                </div>
              </div>
            </div>
          </div>
