          ...
          <div class="container w-100 lg:w-4/5 mx-auto flex flex-col">
            <div v-for="card in cards" class="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100 mx-2">
              ...
              <div class="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                <h3 class="font-semibold text-lg leading-tight truncate">Size: { props.bike.size }</h3>
                <h3 class="font-semibold text-lg leading-tight truncate">Type: { props.bike.type }</h3>
                <h2 class="font-semibold text-lg leading-tight truncate">In stock: { props.bike.count }</h2>
                <p class="mt-2">
